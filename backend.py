...
async def generate_stream(user_message: str, previous_user: Optional[str], previous_ai: Optional[str], summary: Optional[str], src: Optional[str] = "nuclear-reaction"):
